    ...
    public class EmailService : ServiceBase, IEmailService
    {
        ...
        public async Task<bool> CreateDefaultEmailTemplate ()
        {
            try
            {
                ...
                "D4Y support" +
                "</span> ",
                    EmailSubject = "Thông tin đăng nhập hệ thống [decor4you.vn]"
                };
                ...
                "D4Y support" +
                "</span> ",
                    EmailSubject = "Thay đổi mật khẩu đăng nhập hệ thống [decor4you.vn]"
                };
                ...
                "D4Y support" +
                "</span> ",
                    EmailSubject = "Khôi phục mật khẩu đăng nhập hệ thống [decor4you.vn]"
                };
                ...
                "D4Y support <br/><br/>" +
                "</span> ",
                    EmailSubject = "Báo giá tới quý khách hàng [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Báo giá được gửi [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Hợp đồng được trình duyệt [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Hợp đồng được thu hồi [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Hợp đồng được phê duyệt [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Hợp đồng bị từ chối [decor4you.vn]"
                };
               ...
               "D4Y support <br/><br/>" +
               "</span> ",
                    EmailSubject = "Hợp đồng bị hủy [decor4you.vn]"
                };
                ...
                if (!await _emailRepository.CheckNameExistsAsync("D4YQuotation"))
